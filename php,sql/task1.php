<?php 
    ...
    $name = "Nikita";
    $city = "Gadzhyevo, Russia";
    $prof = "Navy";
    $email = "smiels270298@mail.ru";
    $phone = 79045154366;
    $skills = [
    		'skill_name' => ['bash', 'python', 'c#', 'assembler'],
            'level' => [70,50,30,20]
    ];
    $jobs = [
    		'job_name' => ['SSBN','Naval University','School'],
            'duration' => ['Jun 2020', 'Aug 2015 - May 2020', 'Sep 2004 - Jun 2015'],
            'description' => ['submersible ship ballistic nuclear','branch of Kuznetsov Naval Academy','10th middle school of Severomorsk city']
    ];
    
    
    $age = 2022-1998;
    $age_days = (2022-1998)*365
?>
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="https://imgfon.ru/Img/Crop/854x480/Movies/start-sonic-sonik-temno-molnii.jpg?img.1" style="width:100%" alt="Avatar">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>smiels270298@mail.ru</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $phone?></p>
          <p><i class="fa fa-bug fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $age, '(',$age_days,')'?></p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs['duration'][0]?> - <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p><?php echo $jobs['description'][0]?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $jobs['job_name'][1]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs['duration'][1]?></h6>
          <p><?php echo $jobs['description'][1]?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $jobs['job_name'][2]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs['duration'][2]?></h6>
